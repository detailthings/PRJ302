                            ...
                            <div class="card-transparent card-block card-stretch card-height">
                                <div class="card-body p-0">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <p>Number of project haven't applied by student: ${numberOfRequestNotStudentID}</p>
                                            <p>Number of project have applied by student: ${numberOfRequestHaveStudentID}</p>
                                            <p>Number of project: ${numberOfProject}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!--                                    <div class="card card-list">
        ...
        <%--<%@include file="/jsp/common/layout/chatbot-widget.jsp" %>--%>
    </body>
</html>
...
<%@page import="model.MemberOfProject"%>
...
<html>
    ...
    <body>
        ...
        <div class="project-card">
            ...
            <form action="TeacherCreateRequest" method="get">
                <table>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="title" id="title" maxlength="255" required></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="number" name="teacherId" id="teacherId" required></td>
                    </tr>
                    <tr>
                        <td><label for="createdAt">Created At:</label></td>
                        <td><input type="datetime-local" name="createdAt" id="createdAt" required></td>
                    </tr>
                    <tr>

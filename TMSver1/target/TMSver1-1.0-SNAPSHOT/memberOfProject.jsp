        ...
        <nav>
            ...
            <a href="TeacherReadProject">Đồ án</a>           
                    ...
                    <div class="project-card">
                        ...
                        <%List<MemberOfProject> rev = (List<MemberOfProject>) request.getAttribute("memberOfProject");%>
                        <a>------------------------------------------------------------------------------------------------------------------------------------------Member in project-------------------------------------------------------------------------------------------------------------------------------------- </a>
                        <table class="tbReview" >
                            ...
                            <tbody>
                                <%for (MemberOfProject r : rev) {%>
                                <tr>
                                    <td><%= r.getUserID()%></td>
                                    <td><%= r.getMajor()%></td>
                                    <td><%= r.getGroupName()%></td>
                                    <td><%= r.getProjectID()%></td>
                                </tr>
                                <%
                                    }
                                %>

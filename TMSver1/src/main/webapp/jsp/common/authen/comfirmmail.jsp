<%-- 
    ...
    Created on : Jul 2, 2025, 6:05:44 PM
    Author     : admin
--%>
                     ...
                     <div class="card-body p-0">
                        <div class="d-flex align-items-center auth-content">
                           <div class="col-lg-6 bg-primary content-left">
                              <div class="p-3">
                                 <img src="${path}/jsp/assets/images/login/mail.png" class="img-fluid" width="80" alt="">
                                 ...
                                 <div class="d-inline-block w-100">
                                    <a href="${path}/logincontroller" class="btn btn-white mt-3">Back to Home</a>
                                 </div>
                              </div>
                           </div>
